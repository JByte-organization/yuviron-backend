...
{
    /// <inheritdoc />
    public partial class addUpdatedDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextAttemptUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    OwnerUniqueConstraint = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CASE WHEN Role = 1 THEN 1 ELSE NULL END", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    CountryCode = table.Column<string>(type: "char(2)", fixedLength: true, maxLength: 2, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SourceType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_albums_VisibilityStatus_CreatedAt",
                table: "albums",
                columns: new[] { "VisibilityStatus", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_artist_team_members_ArtistId_OwnerUniqueConstraint",
                table: "artist_team_members",
                columns: new[] { "ArtistId", "OwnerUniqueConstraint" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_artists_VerificationStatus_CreatedAt",
                table: "artists",
                columns: new[] { "VerificationStatus", "CreatedAt" });
