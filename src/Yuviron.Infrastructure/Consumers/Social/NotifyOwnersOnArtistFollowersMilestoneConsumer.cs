...
{
    public NotifyOwnersOnArtistFollowersMilestoneConsumer(IApplicationDbContext context, INotificationService notificationService) : base(context, notificationService) { }
