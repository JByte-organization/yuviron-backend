...
public sealed class GetTrackByIdQueryHandler : IRequestHandler<GetTrackByIdQuery, TrackDetailsDto>
{
    ...
    public async Task<TrackDetailsDto> Handle(GetTrackByIdQuery request, CancellationToken cancellationToken)
    {
        var track = await _context.Tracks
            ...
            .Select(t => new TrackDetailsDto(
                ...
                t.TrackGenres.Select(tg => tg.GenreId).ToList()    // Вытаскиваем только ID жанров
            ))
